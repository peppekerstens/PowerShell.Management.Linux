function Remove-Service {
    <#
    .Synopsis
        Not yet implemented on Linux. Delegates to Microsoft.PowerShell.Management\Remove-Service on Windows.
    .Notes
    ...
    if ($IsLinux) {
        Write-Warning "Remove-Service is not yet implemented in PowerShell.Management.Linux. Contributions welcome: https://github.com/peppekerstens/PowerShell.Management.Linux"
        return
    }
